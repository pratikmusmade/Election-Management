				...
				<form class="row g-3" name="myForm"  method="post" id="addWaredn"
					...
					<div class="col-md-4">
						<label for="validationServer03" class="form-label">Last
							name</label> <input type="text" class="form-control "
							id="validationServer03" name="lastName" onblur="validate(event,'lastName-validation')" required />
					...
					<div class="col-md-6">
						<label for="validationServer07" class="form-label">Phone
							Number</label> <input type="number" class="form-control "
							id="validationServer07" name="phoneNumber" onblur="validate(event,'phone-validation')" required />
...
>>>>>>> pratik
						...
						<div class="col-md-6">
							<label for="validationEmail" class="form-label">Email</label> <input
								type="email" class="form-control is-invalid"
								id="validationEmail"
								aria-describedby="validationServer03Feedback" name="email"
								required />
							<div id="validationServer03Feedback" class="invalid-feedback">
